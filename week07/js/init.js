...
function createMap() {
  ...
  // Rest of your code for adding markers, layers, legend, etc.

  // Add the fullscreen control
  L.control.fullscreen().addTo(map);
}

function loadFullscreenLibrary(callback) {
  var fullscreenScript = document.createElement('script');
  fullscreenScript.src = 'https://api.mapbox.com/mapbox.js/plugins/leaflet-fullscreen/v1.0.1/Leaflet.fullscreen.min.js';
  fullscreenScript.onload = callback;
  document.head.appendChild(fullscreenScript);

  var fullscreenStylesheet = document.createElement('link');
  fullscreenStylesheet.href = 'https://api.mapbox.com/mapbox.js/plugins/leaflet-fullscreen/v1.0.1/leaflet.fullscreen.css';
...
window.addEventListener('DOMContentLoaded', function () {
  loadFullscreenLibrary(createMap);
